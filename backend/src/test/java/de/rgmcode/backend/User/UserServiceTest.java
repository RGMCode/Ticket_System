...
class UserServiceTest {
    ...
    public void test_returns_list_of_all_users_when_repository_not_empty() {
        ...
        userList.add(new User("1", "uuid1", "2022-01-01", "12:00:00", "Mr.", "Mr.", "Doe", "John", "IT", "Location1", "Building1", "Room1", "1234567890", "john.doe@example.com", "johndoe", "password", "user"));
        userList.add(new User("2", "uuid2", "2022-01-02", "13:00:00", "Mrs.", "Mrs.", "Smith", "Jane", "HR", "Location2", "Building2", "Room2", "0987654321", "jane.smith@example.com", "janesmith", "password", "admin"));
