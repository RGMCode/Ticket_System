...
//             // Modify the search criteria as needed. For example, you can search by customer headline.
...
//                 <input
//                     type="text"
//                     placeholder="Search by customer headline..."
//                     value={searchInput}
...
export default function TicketOverview() {
    ...
    useEffect(() => {
        // Filter tickets based on search input and update searchResults
        const searchQuery = searchInput.toLowerCase();
        const results = tickets.filter((ticket) => {
            // Modify the search criteria as needed. For example, you can search by customer headline.
            return ticket.customerHeadline.toLowerCase().includes(searchQuery);
